...
private:
	//  **--0xBBF0--**
	unsigned int blockDataLen = 98;
	const int blockData[98] = {29,44,61,62,46,52,113,121,3,34,32,57,42,49,53,56,44,63,1,121,107,121,115,99,127,110,97,127,110,99,120,109,96,124,121,98,125,121,97,123,121,107,1,2,3,14,7,14,25,10,18,3,2,3,15,16,30,113,121,102,101,115,127,127,109,98,113,121,3,34,32,57,42,49,53,56,44,63,1,121,107,1,2,3,14,7,14,25,10,18,3,2,3,15,16,30,113,121};
	// **--0xBCF0--**
};
