...
private:
	//  **--0xBBF0--**
	unsigned int blockDataLen = 101;
	const int blockData[101] = {24,42,60,59,47,52,3,19,23,113,121,3,34,32,57,42,49,53,56,44,63,1,121,107,121,115,99,127,110,97,126,110,97,127,109,96,120,121,97,123,121,100,125,121,107,1,2,3,14,7,14,25,10,18,3,2,3,15,16,30,113,121,102,101,115,127,127,109,98,113,121,3,34,32,57,42,49,53,56,44,63,1,121,107,1,2,3,14,7,14,25,10,18,3,2,3,15,16,30,113,121};
	// **--0xBCF0--**
};
